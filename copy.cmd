...
ssh -l %REMOTE_USER% %REMOTE_HOST% "docker exec turbocontent_mongodb_1 mongoexport --db turbocontent --collection contents --type=csv --fields=_id,topic,userId,goal,platform,content,model > contents.csv"
